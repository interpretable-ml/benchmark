        	...
        	<div className="instructions well">
              ...
              <table style={{display: "inline-block", textAlign: "left"}}><tbody>
                ...
                <tr>
                  ...
                  <td style={{fontWeight: "bold", color: "#009900"}}>
                    NO
                  </td>
                </tr>
              </tbody></table>
              ...
              <table style={{display: "inline-block", textAlign: "left"}}><tbody>
                ...
                <tr>
                  <td style={{textAlign: "right", padding: "3px"}}>
                    They have a cough but no congestion:
                  </td>
                  <td style={{fontWeight: "bold"}}>
                    +1 point
                  </td>
              ...
              <br/>
              Using numbers please allocate blame for their sickness score of <b>2 points</b> among each of the following symptoms:<br/>
              ...
              <table style={{display: "inline-block", textAlign: "left"}}><tbody>
                <tr>
                  ...
                  <td style={{textAlign: "center", width: "150px"}}>
                    ...
                    Congestion: <b style={{color: "#009900"}}>NO</b>
                  </td>
                </tr>
              </tbody></table>
              </div>
