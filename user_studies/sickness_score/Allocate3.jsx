        ...
        <div id="container-instructions">
        	...
        	<div className="instructions well">
              ...
              <table style={{display: "inline-block", textAlign: "left"}}><tbody>
                ...
                <tr>
                  <td style={{textAlign: "right", padding: "3px"}}>
                    If they have <i>both</i> a cough and congestion:
                  </td>
                  <td>
                    +6 points
                  </td>
              ...
              This leads to a sickness score of <b>8 points</b> becase:<br/>
              <div style={{textAlign: "center"}}>
              <table style={{display: "inline-block", textAlign: "left"}}><tbody>
                <tr>
                  <td style={{textAlign: "right", padding: "3px"}}>
                ...
                <tr>
                  <td style={{textAlign: "right", padding: "3px"}}>
                    They have <i>both</i> a cough and congestion:
                  </td>
                  <td style={{fontWeight: "bold"}}>
                    +6 points
                  </td>
              ...
              <br/>
              Using numbers please allocate blame for their sickness score of <b>8 points</b> among each of the following symptoms:<br/>
