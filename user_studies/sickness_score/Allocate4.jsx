      ...
      <MuiThemeProvider>
        <div id="container-instructions">
        	...
        	<div className="instructions well">
              ...
              <table style={{display: "inline-block", textAlign: "left"}}><tbody>
                <tr>
                  <td style={{textAlign: "right", padding: "3px"}}>
                    If they have a fever <i>and</i> a cough <i>and</i> congestion:
                  </td>
                  <td>
                    +60 points
                  </td>
              ...
              This leads to a sickness score of <b>60 points</b> becase:<br/>
              <div style={{textAlign: "center"}}>
              <table style={{display: "inline-block", textAlign: "left"}}><tbody>
                <tr>
                  <td style={{textAlign: "right", padding: "3px"}}>
                    They have a fever <i>and</i> a cough <i>and</i> congestion:
                  </td>
              ...
              <br/>
              Using numbers please allocate blame for their sickness score of <b>60 points</b> among each of the following symptoms:<br/>
